...
export default function PassengerLayout() {
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        <Tabs.Screen name="index" options={{ title: "Accueil", tabBarIcon: ({ color, size }) => <Icon name="map-search" size={size} color={color} /> }} />
        <Tabs.Screen name="rides" options={{ title: "Mes courses", tabBarIcon: ({ color, size }) => <Icon name="car-multiple" size={size} color={color} /> }} />
