...
const styles = StyleSheet.create({
  ...
  inputRow: { flexDirection: "row", gap: theme.spacing.sm, marginTop: theme.spacing.sm },
  input: { flex: 1, backgroundColor: theme.color.surface, borderRadius: theme.radius.md, paddingHorizontal: theme.spacing.lg, height: 48, fontSize: 15, color: theme.color.onSurface, borderWidth: 1, borderColor: theme.color.border },
  btn: { backgroundColor: theme.color.brand, paddingHorizontal: theme.spacing.lg, height: 48, borderRadius: theme.radius.pill, alignItems: "center", justifyContent: "center", minWidth: 96 },
