...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: "row", flexWrap: "wrap", gap: theme.spacing.sm, marginTop: theme.spacing.md },
  input: { flexGrow: 1, flexBasis: 150, minWidth: 0, backgroundColor: "rgba(255,255,255,0.12)", borderRadius: theme.radius.md, paddingHorizontal: theme.spacing.lg, height: 44, color: "#fff", fontWeight: "700", letterSpacing: 2 },
  btn: { flexGrow: 1, backgroundColor: "#fff", paddingHorizontal: theme.spacing.lg, height: 44, borderRadius: theme.radius.pill, alignItems: "center", justifyContent: "center" },
